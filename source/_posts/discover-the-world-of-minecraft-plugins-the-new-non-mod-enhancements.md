---
title: "Discover the World of Minecraft Plugins: The New Non-Mod Enhancements"
date: 2024-08-28 15:53:46
updated: 2024-08-29 11:32:41
tags:
  - games
  - tv
  - movies
...
The best way to supercharge a PC game, especially after you're mostly done with it, is to install some mods. They can be a great way to make a game fun again. They're usually unofficial, which is why a lot of people stray from them, but what if you could have sanctioned, official "mods" that aren't made by the game developers, but otherwise have an official stamp of approval? This is exactly the concept Minecraft is currently trying out, with "add-ons" coming soon to players.
 ...
 The add-ons are made by developers not from with Mojang or Microsoft, but are available to buy through the [Minecraft Marketplace](https://www.minecraft.net/en-us/catalog). You don't really need to do any complicated setup, as it's just a plug and play solution that you can install from the Minecraft Marketplace. We've seen a few other games take this approach, such as the [Community Creations in Skyrim Special Edition](https://creations.bethesda.net/en/skyrim/featured), but Minecraft hasn't gone that far until now. There are also a number of paid add-ons, which also sets them apart from most mods.
 ...
 Source: [Mojang](https://www.minecraft.net/en-us/article/introducing-add-ons)
