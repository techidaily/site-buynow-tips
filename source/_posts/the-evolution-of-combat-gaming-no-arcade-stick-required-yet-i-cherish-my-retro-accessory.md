...
date: 2024-08-27 15:24:19
updated: 2024-08-29 12:30:52
tags:
  - games
  - tv
  - movies
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/06/some-arcade-sticks.jpg
---

## The Evolution of Combat Gaming - No Arcade Stick Required (Yet I Cherish My Retro Accessory)

### Key Takeaways

* Modern fighting games are designed for console controllers to simplify inputs & appeal to a wider audience.
* Arcade sticks offer a unique and immersive experience, enhancing gameplay with physicality & an old-school feeling with a learning curve to match.
* Choose the right controller for you: a controller, a fight pad, or a fight stick, depending on preference and comfort level.
...
![A HORI fightpad for PlayStation.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/06/img_6318.jpeg) 
...
Hori Fighting Commander Octa for PlayStation 5
 ...
 This is perfect for games like _Street Fighter_ which use a six-button layout. The most popular product in this category (and the one I use) is the [Hori Fighting Commander OCTO](https://stores.horiusa.com/fighting-commander-octa-for-playstation-5/) line, which retails for $59.99\. Note that these controllers typically require a wired connection that can run on a slightly shorter side, so make sure to measure the distance from your console to your couch first.
...
Mayflash Arcade Stick F500 V2 with Magic-S Ultimate Wireless Bluetooth USB Adapter
 ...
 My recommendation for a starter stick is the [Mayflash Arcade Stick F500 V2](https://www.mayflash.com/product/showproduct.php?id=31) ($89.99). While the cheaper [F300](https://www.mayflash.com/product/mayflash%5Farcade%5Fstick%5Ff300.html) gets the job done, the F500 V2’s larger size gives you ample room to rest your hands and the metal build is sturdier, all while remaining within a reasonable price range.

 While you aren’t getting arcade-quality parts, the buttons that come installed do their job and the internal wiring is designed for you to add higher-end parts should you choose to do so. Unlike most sticks which are locked to a specific console, the F500 V2 is compatible across all major platforms except PlayStation 5\. Due to Sony’s restrictions on third-party controllers, you’ll need the [Mayflash Magic-S Ultimate USB](https://www.mayflash.com/product/magic%5Fs%5Fultimate.html) adapter ($38.99) for.

 If you plan to exclusively fight on PS5, you may want to consider the [Qanba Drone 2](https://qanbausa.com/drone-2/) ($109.99) which is native to the platform and includes a touchpad.

 My current stick of choice is the [Qanba Obsidian 2](https://qanbausa.com/obsidian-2/) ($249.99), but I would highly recommend against breaking the bank on your first stick. Consider this an upgrade recommendation for stick converts who want all the bells and whistles in an undeniably sexy package.
...
##  Play How You Want (But Fight Sticks Are Cool)
 ...
 But if you want something extra special out of your brawls, it might be worth giving a fight stick a shot. While even a cheap stick isn’t cheap, and they require some dedication to learn, the payoff is physical stimulation singular to [playing fighting games arcade-style](https://fox-hovers.techidaily.com/2024-approved-cinematic-mastery-starts-here-the-best-cameras-of-all-levels/).
